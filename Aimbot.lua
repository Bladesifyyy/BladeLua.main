--[[
	...
	Aimbot Module [BladeLua] by Bladesify © CC0 1.0 Universal (2024)
...
if not getgenv().BladeLua or getgenv().BladeLua.Aimbot then return end
...
local Environment = getgenv().BladeLua.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().BladeLua.Aimbot.Functions = nil
	getgenv().BladeLua.Aimbot = nil
